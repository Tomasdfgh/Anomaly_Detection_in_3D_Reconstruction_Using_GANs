...
This directory contains the anomaly detection scripts, which has the main algorithm used in the detection process. This read me file will breakdown the algorithm.
